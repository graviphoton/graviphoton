    ...
    concat: {
      ...
      js: {
        ...
        src: [
          ...
          '<%= dirs.bower.src %>/slickgrid/slick.core.js',
          '<%= dirs.bower.src %>/slickgrid/slick.formatters.js',
          '<%= dirs.bower.src %>/slickgrid/slick.editors.js',
          '<%= dirs.bower.src %>/slickgrid/plugins/slick.rowselectionmodel.js',
          '<%= dirs.bower.src %>/slickgrid/slick.grid.js',
          '<%= dirs.bower.src %>/slickgrid/slick.dataview.js',
          '<%= dirs.bower.src %>/slickgrid/controls/slick.pager.js',
          '<%= dirs.bower.src %>/slickgrid/controls/slick.columnpicker.js',
